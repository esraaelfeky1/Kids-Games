...
export default function ArabicLetterGame() {
  ...
  const sounds = {
    ".": "/sounds/نقطه.mp3",
    "( )": "/sounds/القوسان.mp3",
    "؟": "/sounds/علامه الاستفهام.mp3",
    ":": "/sounds/النقتتان.mp3",
    "!": "/sounds/علامه التعجب.mp3",
    "،": "/sounds/الفاصله.mp3",
    "؛": "/sounds/الفاصله المنقوطه.mp3",
  };
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.top}>
        ...
        <div style={styles.header}>لعبة علامات الترقيم</div>
      ...
      {/* ================= CARD (نفس الحجم العمودي المظبوط) ================= */}
      <div style={styles.card}>
        <p style={styles.gameText}>استمع ثم اختر العلامة الصحيحة</p>
