...
import mainBg from '../assets/sukoobg10.jpeg';
import imgTitle from '../assets/suktitle10.png';
import imgRabbit from '../assets/rabbit3.png';
import imgSquirrel from '../assets/squirrel3.png';

import imgStar from '../assets/strgame10.png';
import imgListen from '../assets/listengame10.png';
import imgDino from '../assets/dinogame10.png';
import imgBalloons from '../assets/fh10.png';
...
const Sukoon = () => {
  ...
  const games = [
    { id: 'imgStar', img: imgStar, path: '/ChairHamzaballe' },
    { id: 'imgListen', img: imgListen, path: '/ChairHamzatmun' },
    { id: 'imgDino', img: imgDino, path: '/ChairHamzatubl' },
    { id: 'imgBalloons', img: imgBalloons, path: '/ChairHamzalicen' }
  ];
  ...
  return (
    <div className="sukoon-container" style={{ 
      ...
      <style>{`
        ...
        .title-img { width: 220px; margin-top: -25px; z-index: 5; }
        .games-grid { 
      ...
      <div style={{ position: 'relative', marginTop: '20px' }}>
        <svg style={{ position: 'absolute', width: '100%', height: '100%', zIndex: 1, pointerEvents: 'none' }}>
          <line x1="50%" y1="0%" x2="50%" y2="100%" stroke="#00357a" strokeWidth="4" strokeDasharray="10 10" />
          <line x1="0%" y1="50%" x2="100%" y2="50%" stroke="#004781" strokeWidth="4" strokeDasharray="10 10" />
        </svg>
      ...
      <img className="side-animal animate-float" src={imgRabbit} alt="أرنب" style={{ position: 'absolute', bottom: '0', left: '10px', width: '130px', pointerEvents: 'none' }} />
      <img className="side-animal animate-float" src={imgSquirrel} alt="سنجاب" style={{ position: 'absolute', bottom: '0', right: '10px', width: '130px', pointerEvents: 'none' }} />
    </div>
  );
};
