...
// =========================
// استيراد جميع الصور (Imports) لمنع اختفائها عند رفع المشروع
// =========================
import writeImg from "../assets/write.png";
import stairsImg from "../assets/stairs.png";
import paintPaletteImg from "../assets/paint-palette.png";
import auditoryImg from "../assets/auditory.png";
...
import ropeSkippingImg from "../assets/rope-skipping.png";
import laughImg from "../assets/laugh.png";
import bingeEatingImg from "../assets/binge-eating.png";
...
export default function TafkheemGame() {
  ...
  const questions = [
    { image: writeImg, word: "كَتَبَ", missing: "كَـ", display: "-تَـبَ", choices: ["قِـ", "سُـ", "كَـ"] },
    { image: stairsImg, word: "صَعَدَ", missing: "عَـ", display: "صَـ _ دَ", choices: ["ضَـ", "عَـ", "دَ"] },
    { image: paintPaletteImg, word: "رَسَمَ", missing: "سَـ", display: "رَـ مَ", choices: ["تَـ", "طَـ", "سَـ"] },
    { image: auditoryImg, word: "سَمَعَ", missing: "عَ", display: "سَمَـ -", choices: ["عَ", "ظَ", "ذَ"] },
    { image: sittingImg, word: "جَلَسَ", missing: "جَـ", display: "- لَـسَ", choices: ["كَـ", "جَـ", "فَـ"] },
    { image: excitedImg, word: "فَرَحَ", missing: "فَـ", display: "_رَحَ", choices: ["فَـ", "سَـ", "طَ"] },
    { image: teamImg, word: "رَبَحَ", missing: "حَ", display: "رَبَـ -", choices: ["سَـ", "خَـ", "حَ"] },
    { image: harvestImg, word: "زَرَعَ", missing: "عَ", display: "زَرَ-", choices: ["عَ", "رَ", "طَ"] },
    { image: ropeSkippingImg, word: "قَفَزَ", missing: "فَـ", display: "قَـ -زَ", choices: ["شَـ", "خَـ", "فَـ"] },
    { image: laughImg, word: "ضَحَكَ", missing: "ضَـ", display: "ـ حَـكَ", choices: ["عَـ", "ضَـ", "صَـ"] },
    { image: bingeEatingImg, word: "أَكَـلَ", missing: "كَـ", display: "أَ ـ لَ", choices: ["كَـ", "ذَ", "ظَ"] },
  ];
    ...
    <>
      ...
      <div style={{ ...styles.page, backgroundImage: `url(${bgImage})` }} className="tafkheem-page">
        <div style={styles.card} className="tafkheem-card">
          ...
          <p style={styles.subtitle} className="tafkheem-subtitle"> اختر حرف عليه حركة الفتح</p>
