...
import mainBg from '../assets/sukoobg15.jpeg';
import imgTitle from '../assets/suktitle15.png';
import imgRabbit from '../assets/rabbit.png';
import imgSquirrel from '../assets/squirrel.png';

import imgStar from '../assets/strgame15.png';
import imgListen from '../assets/listengame15.png';
import imgDino from '../assets/dinogame15.png';
import imgBalloons from '../assets/fh15.png';
...
const Sukoon = () => {
  ...
  const games = [
    { id: 'imgStar', img: imgStar, path: '/Markscandy' },
    { id: 'imgListen', img: imgListen, path: '/Markshlazon' },
    { id: 'imgDino', img: imgDino, path: '/Marksspac' },
    { id: 'imgBalloons', img: imgBalloons, path: '/Markslicen' }
  ];
    ...
    <div className="sukoon-container" style={{ 
      ...
      <div style={{ position: 'relative', marginTop: '20px' }}>
        <svg style={{ position: 'absolute', width: '100%', height: '100%', zIndex: 1, pointerEvents: 'none' }}>
          <line x1="50%" y1="0%" x2="50%" y2="100%" stroke="#f7f8f9" strokeWidth="4" strokeDasharray="10 10" />
          <line x1="0%" y1="50%" x2="100%" y2="50%" stroke="#fdfdfd" strokeWidth="4" strokeDasharray="10 10" />
        </svg>
