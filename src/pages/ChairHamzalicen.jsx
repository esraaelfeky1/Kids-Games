...
export default function ArabicLetterGame() {
  ...
  const questions = [
    ...
    { correct: "جزء", options: ["جزء", "رسم"] },
    { correct: "بئر", options: ["افتح", "بئر"] },
    { correct: "مؤلف", options: ["مؤلف",  "سمع"] },
    { correct: "قرأ", options: ["ربح",  "قرأ"] },
    { correct: "لؤلؤ", options: ["لؤلؤ", "وهب"] },
    { correct: "شاطئ", options: ["شفع", "شاطئ"] },
  ];
  ...
  const sounds = {
    ...
    جزء: "/sounds/جزء.mp3",
    بئر: "/sounds/بئر.mp3",
    مؤلف: "/sounds/مؤلف.mp3",
    قرأ: "/sounds/قرأ.mp3",
    لؤلؤ: "/sounds/لؤلؤ.mp3",
    شاطئ: "/sounds/شاطئ.mp3",
  };
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.top}>
        ...
        <div style={styles.header}>استمع واختر الكلمة التي بها كراسي همزة</div>
      ...
      <div style={styles.bottomButtons}>
        <button
          onClick={() => (window.location.href = "/ChairHamza")}
