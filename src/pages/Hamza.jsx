...
import mainBg from '../assets/sukoobg7.jpeg';
import imgTitle from '../assets/suktitle7.png';
import imgRabbit from '../assets/rabbit.png';
import imgSquirrel from '../assets/squirrel.png';

import imgStar from '../assets/strgame7.png';
import imgListen from '../assets/listengame7.png';
import imgDino from '../assets/dinogame8.png';
import imgBalloons from '../assets/fh7.png';
...
const Sukoon = () => {
  ...
  const games = [
    { id: 'imgStar', img: imgStar, path: '/Hamzaoctups' },
    { id: 'imgListen', img: imgListen, path: '/Hamzaanimal' },
    { id: 'imgDino', img: imgDino, path: '/Hamzacandy' },
    { id: 'imgBalloons', img: imgBalloons, path: '/Hamzawaslicen' }
  ];
  ...
  return (
    <div className="sukoon-container" style={{ 
      ...
      <style>{`
        ...
        .title-img { width: 260px; margin-top: -25px; z-index: 5; }
        .games-grid { 
